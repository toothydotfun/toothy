...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:closetome master @s[tag=radio.play]
...
schedule function toothy:radio/playlist/dontfearthereaper 217s