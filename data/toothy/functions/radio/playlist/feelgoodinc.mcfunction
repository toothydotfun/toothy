...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:feelgoodinc master @s[tag=radio.play]
...
schedule function toothy:radio/playlist/herecomesthesun 223s