...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:comfortablynumb master @s[tag=radio.play]
...
schedule function toothy:radio/playlist/aqualung 382s