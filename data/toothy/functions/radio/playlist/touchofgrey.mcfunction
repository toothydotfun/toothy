...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:touchofgrey master @s[tag=radio.play]
...
schedule function toothy:radio/playlist/karmapolice 355s