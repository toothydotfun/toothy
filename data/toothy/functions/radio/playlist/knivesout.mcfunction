...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:knivesout master @s[tag=radio.play]
...
schedule function toothy:radio/playlist/herecomesyourman 247s