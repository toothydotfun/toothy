...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:backinblack master @s[tag=radio.play]
...
schedule function toothy:radio/playlist/closetome 255s