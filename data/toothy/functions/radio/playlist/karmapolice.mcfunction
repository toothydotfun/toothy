...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:karmapolice master @s[tag=radio.play]
...
schedule function toothy:radio/playlist/knivesout 260s