...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:bigiron master @s[tag=radio.play]
...
schedule function echoes:radio/playlist/africa 237s