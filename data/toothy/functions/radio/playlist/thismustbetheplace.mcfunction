...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:thismustbetheplace master @s[tag=radio.play]
...
schedule function toothy:radio/playlist/bigiron 311s