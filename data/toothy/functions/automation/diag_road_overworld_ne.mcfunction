...
execute if score @s road_timer matches 4 at @s run fill ~-2 ~-1 ~ ~-2 ~-1 ~ minecraft:chiseled_sandstone
execute if score @s road_timer matches 5 at @s run fill ~-1 ~-1 ~ ~-1 ~-1 ~ minecraft:chiseled_sandstone
execute if score @s road_timer matches 6 at @s run fill ~ ~-1 ~ ~ ~-1 ~ minecraft:chiseled_sandstone
execute if score @s road_timer matches 7 at @s run fill ~ ~-1 ~1 ~ ~-1 ~1 minecraft:chiseled_sandstone
