...
execute if score @s road_timer matches 1 in minecraft:overworld at @s run tp @s ~-1 63 ~-1 135 0
...
execute if score @s road_timer matches 4 at @s run fill ~1 ~-1 ~1 ~1 ~-1 ~1 minecraft:chiseled_sandstone
execute if score @s road_timer matches 5 at @s run fill ~ ~-1 ~-1 ~ ~-1 ~-1 minecraft:chiseled_sandstone
execute if score @s road_timer matches 6 at @s run fill ~-1 ~-1 ~ ~-1 ~-1 ~ minecraft:chiseled_sandstone
execute if score @s road_timer matches 7 at @s run fill ~-2 ~-1 ~ ~-2 ~-1 ~ minecraft:chiseled_sandstone
execute if score @s road_timer matches 8 at @s run fill ~ ~-1 ~-2 ~ ~-1 ~-2 minecraft:chiseled_sandstone
