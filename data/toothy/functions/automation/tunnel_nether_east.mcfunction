...
execute if score @s road_timer matches 1 in minecraft:the_nether at @s run tp @s ~1 119 ~
...
execute if score @s road_timer matches 5 at @s run fill ~-3 119 ~ ~30 120 ~ air replace
execute if score @s road_timer matches 6 at @s run fill ~-3 118 ~ ~30 118 ~ cobblestone replace
execute if score @s road_timer matches 7 at @s run fill ~-3 117 ~ ~30 117 ~ obsidian replace
