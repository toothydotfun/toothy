...
execute in minecraft:overworld run summon slime 2.5 63 -7.5 {NoGravity:1b,Silent:1b,Invulnerable:1b,Glowing:1b,CustomNameVisible:1b,NoAI:1b,Size:0,Tags:["wingsofredemption"],CustomName:'{"text":"\\\\/ WingsOfRedemption (jordiejordan) \\\\/","color":"green","bold":true}',ActiveEffects:[{Id:14,Amplifier:1b,Duration:1000000,ShowParticles:0b}]}
