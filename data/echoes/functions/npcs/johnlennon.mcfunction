execute unless entity @p[name=ElliotRodger] run schedule function echoes:npcs/remove/johnlennon 300s
execute unless entity @p[name=ElliotRodger] run schedule function echoes:npcs/speech/johnlennon/start 2s
execute at @s run player JohnLennon spawn
...
tellraw @s "<God> You know what you have to do."
