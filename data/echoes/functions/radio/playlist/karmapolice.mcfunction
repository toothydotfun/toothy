...
schedule function echoes:radio/playlist/herecomesyourman 260s
scoreboard players set #currentSong playerCount 16
tellraw @a[tag=radio.play] ["","<",{"text":"[bot] EchoesRadio","color":"gray"},"> Now playing on Echoes Radio: Radiohead - Karma Police"]
