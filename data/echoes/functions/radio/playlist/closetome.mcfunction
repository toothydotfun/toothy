...
schedule function echoes:radio/playlist/dontfearthereaper 227s
scoreboard players set #currentSong playerCount 8
tellraw @a[tag=radio.play] ["","<",{"text":"[bot] EchoesRadio","color":"gray"},"> Now playing on Echoes Radio: The Cure - Close to Me"]
