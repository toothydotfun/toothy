...
schedule function echoes:radio/playlist/hereatthewesternworld 178s
scoreboard players set #currentSong playerCount 5
tellraw @a[tag=radio.play]] ["","<",{"text":"[bot] EchoesRadio","color":"gray"},"> Now playing on Echoes Radio: The Romantics - What I Like About You"]
