...
execute as @a[tag=radio.play] run title @s actionbar ["",{"text":"--==","bold":true,"color":"dark_gray"},{"text":"YOU'RE LISTENING TO ECHOES RADIO... UP NEXT: ","bold":true,"italic":true,"color":"dark_gray"},{"text":"Radiohead - Karma Police","bold":true,"italic":true,"color":"red"},{"text":"==--","bold":true,"color":"dark_aqua"}]
schedule function echoes:radio/playlist/karmapolice 94s
