...
schedule function echoes:radio/playlist/intheairtonight 236s
scoreboard players set #currentSong playerCount 24
tellraw @a[tag=radio.play]] ["","<",{"text":"[bot] EchoesRadio","color":"gray"},"> Now playing on Echoes Radio: Асқар Жүнісбеков - Жаса, Қазақстан"]
