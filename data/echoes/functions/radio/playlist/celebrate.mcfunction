...
schedule function echoes:radio/playlist/lastresort 320s
scoreboard players set #currentSong playerCount 30
tellraw @a[tag=radio.play] ["","<",{"text":"[bot] EchoesRadio","color":"gray"},"> Now playing on Echoes Radio: Kool & The Gang - Celebrate"]
