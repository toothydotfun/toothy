...
schedule function echoes:radio/playlist/buttercup 12s
scoreboard players set #currentSong playerCount 3
tellraw @a[tag=radio.play] ["","<",{"text":"[bot] EchoesRadio","color":"gray"},"> Now playing on Echoes Radio: STEELY DAN - PLANET DRHONDA"]
