...
schedule function echoes:radio/playlist/planetdrhonda 312s
scoreboard players set #currentSong playerCount 2
tellraw @a[tag=!muteradio] ["","<",{"text":"[bot] EchoesRadio","color":"gray"},"> Now playing on Echoes Radio: Styx - Come Sail Away (With Me)"]
