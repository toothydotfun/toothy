...
execute as @a[tag=radio.play] at @s[tag=radio.play] run playsound minecraft:hereatthewesternworld music @s[tag=radio.play]
...
schedule function echoes:radio/playlist/transisland 249s
