...
schedule function echoes:radio/playlist/erika 303s
scoreboard players set #currentSong playerCount 9
tellraw @a ["",{"text":"[] ","bold":true,"color":"white"},{"text":"Now Playing on Echoes Radio: Blue Öyster Cult - (Don't Fear) The Reaper","color":"dark_aqua"}]
