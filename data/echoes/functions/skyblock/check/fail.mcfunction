...
tellraw @s ["",{"text":"- ","bold":true,"color":"white"},{"text":"6 smooth quartz slabs","color":"dark_aqua"}]
tellraw @s ["",{"text":"- ","bold":true,"color":"white"},{"text":"4 obsidian","color":"dark_aqua"}]
tellraw @s ["",{"text":"- ","bold":true,"color":"white"},{"text":"2 shroomlight blocks","color":"dark_aqua"}]
tellraw @s ["",{"text":"- ","bold":true,"color":"white"},{"text":"4 shulker shells (not boxes)","color":"dark_aqua"}]
tellraw @s ["",{"text":"- ","bold":true,"color":"white"},{"text":"9 glass blocks (not dyed)","color":"dark_aqua"}]
tellraw @s ["",{"text":"- ","bold":true,"color":"white"},{"text":"1 respawn anchor","color":"dark_aqua"}]
