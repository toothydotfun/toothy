...
tellraw @a[tag=tutorial.tpa] ["",{"text":"[] ","bold":true,"color":"white"},{"text":"Click here to run a sample teleport command (3/9).","underlined":true,"color":"#4ABFBF","clickEvent":{"action":"run_command","value":"!tpa FriendsUsernameHere1234"}}]
tellraw @a[tag=tutorial.tpa] ""
