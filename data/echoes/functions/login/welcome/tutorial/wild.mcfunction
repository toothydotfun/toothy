...
tellraw @a[tag=tutorial.wild] ["",{"text":"[] ","bold":true,"color":"white"},{"text":"You\'re at server spawn. If you\'re unhappy with this place, you can swim or fly away, or follow the nether tunnels out from spawn to a safer location.","color":"#4ABFBF"}]
