...
give @s bamboo_raft{display:{Name:'{"text":"Benjamin Rush the Bamboo Raft","color":"gold","italic":true}',Lore:['{"text":"Welcome to Swim!","color":"dark_purple","italic":true}']},Enchantments:[{id:"minecraft:smite",lvl:3s}]} 6
