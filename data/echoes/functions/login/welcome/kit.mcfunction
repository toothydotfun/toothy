...
give @s oak_slab{display:{Name:'{"text":"Olaf Sanderson the Welcome Oak Slab","color":"gold","italic":true}',Lore:['{"text":"Welcome to Echoes!","color":"dark_purple","italic":true}']},Enchantments:[{id:"minecraft:smite",lvl:3s}]} 6
...
#give @s minecraft:spyglass{display:{Name:'{"text":"Spiro the Welcome Spyglass","color":"gold"}',Lore:['{"text":"Welcome to Echoes!","color":"dark_purple","italic":true}']},Enchantments:[{id:"minecraft:knockback",lvl:6s}]} 1
