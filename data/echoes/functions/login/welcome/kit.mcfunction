...
give @s minecraft:acacia_boat{display:{Name:'{"text":"Boris the Welcome Boat","color":"gold"}',Lore:['{"text":"Welcome to Echoes!","color":"dark_purple","italic":true}']},Enchantments:[{id:"minecraft:knockback",lvl:6s}]} 1
