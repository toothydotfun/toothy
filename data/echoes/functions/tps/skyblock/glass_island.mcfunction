...
execute in custom:skyblock at @s anchored feet run setblock ~ ~-10 ~ minecraft:structure_block{name:"glass_island",posX:"~",posY:"~",posZ:"~",rotation:"NONE",mirror:"NONE",mode:"LOAD",ignoreEntities:0b}
