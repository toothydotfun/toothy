...
execute in minecraft:the_overworld positioned 0 120 -13 run player OWnorth spawn
gamemode spectator OWnorth

execute in minecraft:the_overworld positioned 13 120 -13 run player OWnortheast spawn
gamemode spectator OWnortheast

execute in minecraft:the_overworld positioned 13 120 0 run player OWeast spawn
gamemode spectator OWeast

execute in minecraft:the_overworld positioned 13 120 13 run player OWsoutheast spawn
gamemode spectator OWsoutheast

execute in minecraft:the_overworld positioned 0 120 13 run player OWsouth spawn
gamemode spectator OWsouth

execute in minecraft:the_overworld positioned -13 120 13 run player OWsouthwest spawn
gamemode spectator OWsouthwest

execute in minecraft:the_overworld positioned 13 120 0 run player OWwest spawn
