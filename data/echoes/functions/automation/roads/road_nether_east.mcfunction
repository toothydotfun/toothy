...
execute if score @s road_timer matches 1 in minecraft:the_nether at @s run tp @s ~1 120 ~
...
execute if score @s road_timer matches 6 at @s run fill ~-1 119 ~-1 ~1 119 ~1 cobblestone replace
