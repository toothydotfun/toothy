...
execute if score @s road_timer matches 8 at @s run fill ~ 128 ~1 ~ 128 ~-1 redstone_block replace air
execute if score @s road_timer matches 9 at @s run fill ~ 129 ~1 ~ 129 ~-1 powered_rail[shape=east_west,powered=true] replace air
