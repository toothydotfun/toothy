...
execute if score @s road_timer matches 4 at @s run fill ~1 ~-1 ~1 ~1 ~-1 ~1 minecraft:deepslate_tiles
execute if score @s road_timer matches 5 at @s run fill ~ ~-1 ~-1 ~ ~-1 ~-1 minecraft:deepslate_tiles
execute if score @s road_timer matches 6 at @s run fill ~-1 ~-1 ~ ~-1 ~-1 ~ minecraft:deepslate_tiles
execute if score @s road_timer matches 7 at @s run fill ~-2 ~-1 ~ ~-2 ~-1 ~ minecraft:deepslate_tiles
