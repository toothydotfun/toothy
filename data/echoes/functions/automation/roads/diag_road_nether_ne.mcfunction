...
execute if score @s road_timer matches 1 in minecraft:the_nether at @s run tp @s ~1 120 ~-1 -135 0
...
execute if score @s road_timer matches 4 at @s run fill ^ 129 ^1 ^ 133 ^-1 air
