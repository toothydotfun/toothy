...
execute if score @s road_timer matches 1 in minecraft:overworld at @s run tp @s ~1 93 0
...
execute if score @s road_timer matches 6 at @s run fill ~-1 62 ~-1 ~1 92 ~1 cut_sandstone replace
execute if score @s road_timer matches 7 at @s run fill ~1 61 ~-1 ~-1 91 ~1 obsidian replace
