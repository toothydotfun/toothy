...
execute as @a[tag=fidgetspinner,x=0] at @s run function echoes:misc/fidgetspinner
execute as @a[tag=furry,x=0] at @s run function echoes:misc/furry
execute as @a[tag=gay,x=0] at @s run function echoes:misc/gay
execute as @a[tag=minecartafk,x=0] at @s run function echoes:misc/minecartafk
execute as @a[tag=spooky,x=0] at @s run function echoes:misc/spooky
